...
/* Minimum PRBs allocatable per UE and per Slice for 3GPP Type-1 resource allocation / PUSCH grants */
#ifndef MIN_RB_SIZE
#define MIN_RB_SIZE 5
#endif
#ifndef NR_MAC_MIN_RB_SIZE
#define NR_MAC_MIN_RB_SIZE MIN_RB_SIZE
#endif
